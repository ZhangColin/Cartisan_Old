...
//            _commandBus.Submit(deleteUser);
        ...
        public CartisanUserManager _userManager;
        private readonly ISecureDataFormat<AuthenticationTicket> _accessTokenFormat;

        public AccountsController(CartisanUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat) {
        ...
        public CartisanUserManager UserManager {
            get {
                return _userManager ?? Request.GetOwinContext().GetUserManager<CartisanUserManager>();
            }
            private set {
                _userManager = value;
            }
