...
//        }
        ...
        public byte[] CreateImage() {
            return CreateCheckCodeImage(this.CreateRandomCode(this.CodeCount));
        }
        ...
        private byte[] CreateCheckCodeImage(string checkCode) {
            ...
            try {
                ...
                //线性渐变笔刷
                var brush = new LinearGradientBrush(new Rectangle(0, 0, image.Width, image.Height), Color.Green, RandomColor(), 1.2f, true);
