...
namespace Cartisan.Utility.Email {
    public class SmtpSender: IEmailSender {
        ...
        private static void AddTxtView(Email email, MailMessage mailMessage, string templatePath) {
        ...
        private static string ReplaceTemplate(Email email, string txtTemplate) {
