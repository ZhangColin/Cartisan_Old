...
namespace Cartisan.Utility.Image {
    ...
    public class ValidImage {
        ...
        void GetValidateCode() {
            ...
            string str = "abcdefghijkmnpqrstuvwyzABCDEFGHJKLMNPQRSTUVWYZ23456789";//共57个字符，除 l,o,x,I,O,X,1,0 的所有数字和大写字母
        ...
        public bool IsRight(string inputValCode) {
            //无论输入大小写都转换为大些判断
            return this.validStr.ToUpper().Equals(inputValCode.ToUpper());
        }
    }
}