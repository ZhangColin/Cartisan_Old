...
namespace Cartisan.Dapper {
    public static class DapperHelper {
        public static IDbConnection GetConnection() {
            return GetConnection("YouQiuConnectionString");
        }

        public static SqlConnection GetConnection(string connectionName) {
            var connection =
                new SqlConnection(ConfigurationManager.ConnectionStrings[connectionName].ConnectionString);
            connection.Open();
            return connection;
        }
