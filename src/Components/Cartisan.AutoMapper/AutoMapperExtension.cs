...
//        public static TDestination ToMapObject<TDestination>(this object src)
//               where TDestination : class {
//            Mapper.CreateMap(src.GetType(), typeof(TDestination));
//            var dest = Mapper.Map(src, src.GetType(), typeof(TDestination)) as TDestination;
//            return dest;
//        }
//
//        public static TDestination ToMapObject<TSource, TDestination>(this TSource src,
